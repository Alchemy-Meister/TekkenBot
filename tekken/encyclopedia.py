...
from constants.battle import MainMenus, PunishResult
...
class TekkenEncyclopedia:
    ...
    def get_player_string(self, game_state: TekkenGameState, reverse=False):
        ...
        # is_player_one_conditions = [
        #     self.is_player_one, not last_game_state.is_camera_flipped()
        # ]
        # is_player_one_inverted_conditions = [
        #     not condition for condition in is_player_one_conditions
        # ]
        # if(
        #         any(
        #             [
        #                 all(is_player_one_conditions),
        #                 all(is_player_one_inverted_conditions)
        #             ]
        #         )
        #         and not reverse
        # ):
        ...
        #         self.is_player_one
        #         and not reverse
        #         or not self.is_player_one
        #         and reverse
        # ):
        if self.is_player_one != reverse:
            return 'p1: '
        return 'p2: '
            ...
            if(
                ...
                self.current_game_event = (
                    GameStatEventEntry(
                        ...
                        self.get_player_string(game_state, True),
                        hit,
                        combo_counter_damage
                    )
                )
